...
export class AppComponent implements OnInit {
  ...
  constructor(
    ...
    public settingsService: SettingsService // private serviceWorkerConfiguration: ServiceWorkerConfigurationService
  ) {}
  ...
  ngOnInit() {
    ...
    this.settingsService.setGlobalInterviewModeStyles();
